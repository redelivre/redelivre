			            ...
			            <section id="mobilize-banners" class="mobilize-widget clearfix">
			                ...
			                <?php for ($i = 0; $i < Mobilize::getNumBanners(); $i++): ?>
			                    ...
			                    <div class="mobilize-banners" style="padding-left: 0;">
			                        ...
			                        <textarea class="code"><?php echo htmlentities('<a href="' . home_url() . '"><img src="' . Mobilize::getBannerURL(250, $i) . '" /></a>') ?></textarea>
			                    ...
			                    <div class="mobilize-banners">
			                        ...
			                        <textarea class="code"><?php echo htmlentities('<a href="' . home_url() . '"><img src="' . Mobilize::getBannerURL(200, $i) . '" /></a>') ?></textarea>
			                        <input class="code" type="text" readonly="readonly" value="<?php the_permalink(); ?>" />                   
			                    </div>
			                    <div class="mobilize-banners">
			                        <!-- banner de 125x125 -->
			                        ...
			                        <textarea class="code"><?php echo htmlentities('<a href="' . home_url() . '"><img src="' . Mobilize::getBannerURL(125, $i) . '" /></a>') ?></textarea>
			                        <input class="code" type="text" readonly="readonly" value="<?php the_permalink(); ?>" />   
			                    </div>
			                    <?php } ?>
			                <?php endfor; ?>
