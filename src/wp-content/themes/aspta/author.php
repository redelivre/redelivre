			...
			echo apply_filters( 'thematic_open_id_content', '<div id="content">' . "\n" );
    	        ...
    	        if($thm_authorinfo == 'true' & !is_paged()) { ?>
    	            ...
    	            <div id="author-info" class="vcard">
						...
						$avatar = str_replace( 'class="photo"', 'class="photo avatar"', get_avatar($email, 150) );
						echo $avatar;
    				...
    				<div id="author-email">
    	                <a class="email" title="<?php echo antispambot($authordata->user_email); ?>" href="mailto:<?php echo antispambot($authordata->user_email); ?>">Mande um email para <span class="fn n"><span class="given-name"><?php echo $authordata->first_name; ?></span> <span class="family-name"><?php echo $authordata->last_name; ?></span></span></a>
