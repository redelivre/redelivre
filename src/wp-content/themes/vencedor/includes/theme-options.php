...
function themename_customize_register($wp_customize) {
    ...
    $wp_customize->add_section( 'vencedor_barra_lateral', array(
        'title'          => 'Barra Lateral',
        'priority'       => 35,
    ) );
    ...
    $wp_customize->add_control( 'themename_color_scheme', array(
        ...
        'section'    => 'vencedor_barra_lateral',
    ...
    if ( $wp_customize->is_preview() && ! is_admin() )
	    add_action( 'wp_footer', 'vencedor_customize_preview', 21);
    
    
}

function vencedor_customize_preview() {
