...
?>
	...
	<div class="guarani-credits cf">
            <a href="http://redelivre.org.br/" title="<?php _e( 'Campanha Completa', 'guarani' ); ?>" class="icon-campanha-completa"><img src="<?php echo get_template_directory_uri() . '/images/icon-campanha-completa.png'; ?>" alt="<?php _e( 'Campanha Completa logo', 'guarani' ); ?>" /><span class="assistive-text"><?php _e( 'Campanha Completa', 'guarani' ); ?></span></a>
