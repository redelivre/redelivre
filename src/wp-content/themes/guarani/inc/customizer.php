...
global $menu;
	...
	if ( current_user_can( 'edit_theme_options' ) ) {
		// In main menu
		add_menu_page( sprintf( __( 'Customize %s', 'default' ), get_bloginfo( 'blogname' ) ), sprintf( __( 'Customize %s', 'default' ), get_bloginfo( 'blogname' ) ), 'edit_theme_options', 'customize.php?url=index.php', '', '', 61 );
