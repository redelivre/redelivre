...
<body>
	...
	echo $contents;
	?>
	<h4><?php _e('You are temporarily locked out', 'wordfence'); ?></h4>
	<p><?php _e('You have been temporarily locked out of this system. This means that you will not be able to log in for a while.', 'wordfence'); ?></p>
