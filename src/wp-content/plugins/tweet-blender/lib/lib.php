...
$tb_refresh_periods = array(
	...
	__('Apenas uma vez (ao carregar)', 'tweetblender') => 1,
	sprintf(__('A cada %d segundos', 'tweetblender'),5) => 5,
	sprintf(__('A cada %d segundos', 'tweetblender'),10) => 10,
	sprintf(__('A cada %d segundos', 'tweetblender'),15) => 15,
	sprintf(__('A cada %d segundos', 'tweetblender'),20) => 20,
	sprintf(__('A cada %d segundos', 'tweetblender'),30) => 30,
	__('A cada minuto', 'tweetblender') => 60,
	sprintf(__('A cada %d minutos', 'tweetblender'),2) => 120,
);

$tb_throttle_time_options = array(
	__('all time', 'tweetblender') => 0,
	'1 ' . __('minuto', 'tweetblender') => 60,
	'5 ' . __('minutos', 'tweetblender') => 300,
	'10 ' . __('minutos', 'tweetblender') => 600,
	'20 ' . __('minutos', 'tweetblender') => 1200,
	'30 ' . __('minutos', 'tweetblender') => 1800,
	'60 ' . __('minutos', 'tweetblender') => 3600,
	'90 ' . __('minutos', 'tweetblender') => 5400,
	'120 ' . __('minutos', 'tweetblender') => 7200
);

$tb_keep_tweets_options = array(
	__('Do not delete them', 'tweetblender') => 0,
	'1 ' . __('dia', 'tweetblender')	=> 1,
	'2 ' . __('dias', 'tweetblender') => 2,
	'3 ' . __('dias', 'tweetblender') => 3,
	'1 ' . __('semana', 'tweetblender') => 7,
	'2 ' . __('semanas', 'tweetblender') => 14,
	'1 ' . __('mês', 'tweetblender') => 30
);
...
$js_labels = array(
	...
	'time_past' => __('{0} {1} atrás', 'tweetblender'),
	'time_future' => __('in {0} {1}', 'tweetblender'),
	'second' => __('segundo', 'tweetblender'),
	'seconds' => __('segundos', 'tweetblender'),
	'minute' => __('minuto', 'tweetblender'),
	'minutes' => __('minutos', 'tweetblender'),
	'hour' => __('hora', 'tweetblender'),
	'hours' => __('horas', 'tweetblender'),
	'day' => __('dia', 'tweetblender'),
	'days' => __('dias', 'tweetblender'),
	'week' => __('semana', 'tweetblender'),
	'weeks' => __('semanas', 'tweetblender'),
	'month' => __('mês', 'tweetblender'),
	'months' => __('meses', 'tweetblender'),
	'year' => __('ano', 'tweetblender'),
	'years' => __('anos', 'tweetblender'),
	'check_fail' => __('Falha ao verificar', 'tweetblender'),
	'limit_num' => __('Max is {0}/hour', 'tweetblender'),
	'limit_left' => __('You have {0} left', 'tweetblender'),
	'from' => __('de', 'tweetblender'),
	'reply' => __('responder', 'tweetblender'),
	'follow' => __('seguir', 'tweetblender'),
	'limit_reset' => __('Next reset','tweetblender'),
	'view_more' => __('ver mais','tweetblender') 
);
