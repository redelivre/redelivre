		...
		<?php if ( ! $paypal_is_configured ) { ?>
			...
			<div class="sui-form-field" style="margin-top: 10px;">
				...
				<button
						...
						type="button"
						data-modal-image="<?php echo $plugin_url . 'assets/images/paypal-logo.png'; // WPCS: XSS ok. ?>"
						data-modal-image-x2="<?php echo $plugin_url . 'assets/images/paypal-logo@2x.png'; // WPCS: XSS ok. ?>"
