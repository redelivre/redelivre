...
abstract class Webhook
{
     ...
     * \Forminator\Stripe\SignatureVerificationException if the signature verification
     ...
     * @return \Forminator\Stripe\Event the Event instance
     * @throws \UnexpectedValueException if the payload is not valid JSON,
     * @throws \Forminator\Stripe\Error\SignatureVerification if the verification fails.
     */
