...
Export WooCommerce customers list csv, Export WooCommerce guest customer list csv, Export WordPress users csv, Email customer list daily
...
* Download <strong>extra user related date</strong> (Extra date is one that is added by plugin other then WooCommerce or WordPress). You can add those date variable name in the field list and it will be downloaded in the CSV
