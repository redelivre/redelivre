...
* Pro event booking reminders aren't translated correctly, planned for version 1.2
 ...
 * event-related search attributes won't work due to architectural limitations, if using [locations_map], use [events_map] instead
* MultiSite
