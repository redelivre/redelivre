...
include_once('Audima_OptionsManager.php');

class Audima_InstallIndicator extends Audima_OptionsManager
{
     ...
     * NOTE: You should manually make this match the SVN tag for your main plugin file 'Version' release and 'Stable
     * tag' in readme.txt
     *
     * @return string
     */
     ...
     * should be taken. Assumes that version string comparable by version_compare, examples: '1', '1.1', '1.1.1',
     *     '2.0', etc.
     */
