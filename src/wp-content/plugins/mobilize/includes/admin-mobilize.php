...
<div class="wrap">
    ...
    <h2>
			<?php _e('Configurações da Página de Mobilização'); ?>
		</h2>
    ...
    <form method="post" enctype="multipart/form-data">        
        ...
        <div id="mobiliza-general" class="section">
            <h3><?php _e('Configurações gerais'); ?></h3>
            ...
            <p><label><input type="checkbox" name="mobilize[general][contribua]" data-section="mobilize-general" <?php if (isset($option['general']['contribua'])){ echo 'checked="checked"'; }  ?> />
							<?php _e('Habilitar contribua'); ?>
						</label></p>            
            <?php } ?>

            <p><label><input type="checkbox" name="mobilize[general][ocultarexplicacao]" data-section="mobilize-general" <?php if (isset($option['general']['ocultarexplicacao'])){ echo 'checked="checked"'; }  ?> /> <?php _e('Ocultar texto explicativo'); ?></label></p>
            <p class="section-description">
                <label>
                    <?php _e('Título desta página:'); ?><br>
                    <input size="40" name="mobilize[general][title]" type="text" value="<?php echo isset($option['general']['title']) ? $option['general']['title'] : ''; ?>">
                </label><br><br>
                <label>
                    <?php _e('Espaçamento lateral:'); ?><br>
                ...
                <label><?php _e('Texto explicativo geral para o usuário:'); ?><br/>
        ...
        <ul id="sortable">        
            <li>
                <div id="mobilize-redes" class="section">
                    ...
                    <h3><label><input type="checkbox" name="mobilize[redes][active]" <?php if (Mobilize::isActive('redes')) echo 'checked="checked"' ?> data-section="mobilize-redes" value="1"/> <?php _e('Redes Sociais'); ?></label></h3>          

                   <div class="section-content">
                        <?php Mobilize::printErrors('redes'); ?>
                        <p class="section-description">
                            <label><?php _e('Texto explicativo desta seção para o usuário:'); ?><br>
            ...
            <li>
                <div id="mobilize-banners" class="section">
                    <!--<div class="mobilize-clear"><a href="#" title="mover"><img width="15" src="<?php echo get_bloginfo('url').'/wp-content/plugins/Mobilize/img/move.png'; ?>" alt="mover"></a></div>-->
                    <h3><label><input type="checkbox" name="mobilize[banners][active]" <?php if (Mobilize::isActive('banners')) echo 'checked="checked"' ?> data-section="mobilize-banners" value="1"/> <?php _e('Banners'); ?></label></h3>
                    <p class="mobilize-description"><?php _e('Carregue aqui um banner quadrado de 250x250 pixels que o sistema vai preparar automaticamente 3 tamanhos que seus apoiadores poderão colocar em sites, blogs ou mesmo nas redes sociais.'); ?></p>
            ...
            <li>
                <div id="mobilize-adesive" class="section">
                    <!--<div class="mobilize-clear"><a href="#" title="mover"><img width="15" src="<?php echo get_bloginfo('url').'/wp-content/plugins/Mobilize/img/move.png'; ?>" alt="mover"></a></div>-->
                    <h3><label><input type="checkbox" name="mobilize[adesive][active]" <?php if(Mobilize::isActive('adesive')) echo 'checked="checked"' ?> data-section="mobilize-adesive" value="1"/> <?php _e('Adesive sua Foto'); ?></label></h3>
                    <p class="mobilize-description"><?php _e('Carregue uma imagem pequena com seu nome e número, com isto seus apoiadores poderão adesivar suas fotos para colocar nas redes sociais. Suba uma imagem horizontal com, no mínimo, 150 pixels.'); ?></p>
            ...
            <li>
                <div id="mobilize-enviar" class="section">
                    <!--<div class="mobilize-clear"><a href="#" title="mover"><img width="15" src="<?php echo get_bloginfo('url').'/wp-content/plugins/Mobilize/img/move.png'; ?>" alt="mover"></a></div>-->
                    <h3><label><input type="checkbox" name="mobilize[envie][active]" <?php if(Mobilize::isActive('envie')) echo 'checked="checked"' ?> data-section="mobilize-enviar" value="1"/> <?php _e('Enviar para um amigo'); ?></label></h3>
                    <p class="mobilize-description"><?php _e('Esta é uma mensagem padrão que seus apoiadores poderão enviar para várias pessoas.  Insira o assunto da mensagem (ex: Eu apoio “Candidato X”) e um texto para a mensagem. Seja sucinto, mas passe sua mensagem.'); ?></p>
                    ...
                    <div class="section-content">
                        ...
                        <p>
                            <label><?php _e('Assunto da mensagem que será enviada por e-mail:'); ?><br/>
                        ...
                        <p>
                            ...
                            <label><?php _e('Mensagem que será enviada por e-mail:'); ?><br/>
